...
class ExerciseService(val ratingRepository: RatingRepository, val exerciseRepository: ExerciseRepository, val moduleRepository: ModuleRepository, val userRepository: UserRepository, val exerciseTypeRepository: ExerciseTypeRepository, val tagRepository: TagRepository) {
    ...
    fun getExercise(exerciseID: Int): ExerciseRet {
        ...
        return ExerciseRet(exercise.exercise_id, moduleRepository.findById(exercise.module_id).get(), exercise.title, exercise.content, exercise.description, exercise.exercisePublic, ratingRepository.averageExerciseRating(exercise.exercise_id), exerciseTypeRepository.getExerciseTypeName(exercise.type_id),tagRepository.getExerciseTags(exercise.exercise_id))
    }
    ...
    fun updateExercise(exercise: ExerciseRet): ExerciseRet {
        ...
        return ExerciseRet(exercise.exercise_id, moduleRepository.findById(exercise.module.module_id).get(), exercise.title, exercise.content, exercise.description, exercise.exercisePublic, ratingRepository.averageExerciseRating(exercise.exercise_id), exercise.type,tagRepository.getExerciseTags(exercise.exercise_id))
    }
    ...
    fun deleteExercise(exerciseID: Int): ExerciseRet {
        ...
        val ret = ExerciseRet(exercise.exercise_id, moduleRepository.findById(exercise.module_id).get(), exercise.title, exercise.content, exercise.description, exercise.exercisePublic, ratingRepository.averageExerciseRating(exercise.exercise_id), exerciseTypeRepository.getExerciseTypeName(exercise.type_id),tagRepository.getExerciseTags(exercise.exercise_id))
