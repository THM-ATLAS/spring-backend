...
class ExerciseController(val exerciseService: ExerciseService) {
    ...
    fun loadExercises(@AuthenticationPrincipal user: AtlasUser, @PathVariable userID: Int): Set<ExerciseRet> {
    ...
    fun loadExercisesModule(@AuthenticationPrincipal user: AtlasUser, @PathVariable modID: Int): List<ExerciseRet> {
    ...
    fun getExercise(@AuthenticationPrincipal user: AtlasUser, @PathVariable exerciseID: Int): ExerciseRet {
    ...
    fun editExercise(@AuthenticationPrincipal user: AtlasUser, @RequestBody body: ExerciseRet): ExerciseRet {
    ...
    fun postExercise(@AuthenticationPrincipal user: AtlasUser, @RequestBody exercise: Exercise): ExerciseRet {
    ...
    fun deleteExercise(@AuthenticationPrincipal user: AtlasUser, @PathVariable exerciseID: Int): ExerciseRet {
